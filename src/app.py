...
def signup_for_activity(activity_name: str, email: str):
    """
    Registers a student for a specified activity by adding their email to the activity's participant list.
    ...
    Raises:
        HTTPException: If the specified activity does not exist.

    Returns:
        dict: A message confirming the student has been signed up for the activity.
    """
